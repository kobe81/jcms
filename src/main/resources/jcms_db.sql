...
Source Database       : jcms_db

Target Server Type    : MYSQL
Target Server Version : 50717
File Encoding         : 65001

Date: 2018-03-26 00:49:53
*/
...
CREATE TABLE `hotel` (
  ...
  `lowest_price` decimal(10,2) DEFAULT NULL COMMENT '最低价格',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='酒店详情';
...
CREATE TABLE `rooms` (
  ...
  `room_price` decimal(10,2) DEFAULT NULL COMMENT '房间价格',
  `remark` varchar(1000) DEFAULT NULL COMMENT '备注',
  `beds` int(11) DEFAULT NULL COMMENT '床位',
  `numbers` int(11) DEFAULT NULL COMMENT '房间数量',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='酒店房间描述';
...
CREATE TABLE `scenic_discuss` (
  ...
  `scenice_id` bigint(11) DEFAULT NULL COMMENT '景点ID',
  `content` varchar(1000) DEFAULT NULL COMMENT '评论内容',
  `creat_time` datetime NOT NULL ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=55 DEFAULT CHARSET=utf8 COMMENT='用户景点留言表';
...
CREATE TABLE `scenic_info` (
  ...
  `TYPE` varchar(10) DEFAULT NULL COMMENT '类型(10：纯文字，20：图文）',
  `remark` varchar(1000) DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='景点详情';
...
CREATE TABLE `sys_file` (
  ...
  `CREAT_TIME` datetime DEFAULT NULL COMMENT '创建时间',
  `TYPE` varchar(20) DEFAULT NULL COMMENT '管理类型',
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=25 DEFAULT CHARSET=utf8 COMMENT='系统文件';
...
CREATE TABLE `sys_user` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1241 DEFAULT CHARSET=utf8 COMMENT='用户';

-- ----------------------------
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES ('1240', '123456', null, 'ea48576f30be1669971699c09ad05c94', '1234567', null, null, '1', null);
...
CREATE TABLE `user_room` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `user_id` bigint(11) DEFAULT NULL COMMENT '用户ID',
  `hotel_id` bigint(11) DEFAULT NULL COMMENT '酒店ID',
  `room_id` bigint(20) DEFAULT NULL COMMENT '房间ID',
  `numbers` int(11) DEFAULT NULL COMMENT '数量',
  `stay_in_time` datetime DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP COMMENT '入住时间',
  `days` int(10) DEFAULT NULL COMMENT '入住天数',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='用户酒店订房表';
